  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center gap-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-widest text-[#d7def7] transition-colors duration-300">
        ...
        <div className="w-full flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-16">
          ...
          >
            <p className="theme-text-muted text-[16px] text-[#a8b3d1] leading-relaxed transition-colors duration-300">
              My studies have helped me build a strong foundation in{" "}
              <span className="font-semibold text-[#64ffda]">software development</span>{" "}
            ...
            <p className="theme-text-muted text-[16px] text-[#a8b3d1] leading-relaxed transition-colors duration-300">
              ...
              <span className="font-semibold text-[#64ffda]">programming</span>,{" "}
              <span className="font-semibold text-[#64ffda]">database design</span>, and{" "}
              <span className="font-semibold text-[#64ffda]">web technologies</span>{" "}
